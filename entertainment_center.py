...
#This Python file contains information about movies
#Instances of Favorite Movies

lord_of_rings = media.Movie("Lord of The Rings",
                            "The story of a boy and his friend trying to destroy a powerful ring",
                            "https://upload.wikimedia.org/wikipedia/pt/8/87/Ringstrilogyposter.jpg",
                            "https://www.youtube.com/watch?v=IUerKBZHnBs",
                            "2001",
                            "All you have to decide is what to do with the time that is given to you.")

harry_potter = media.Movie("Harry Potter",
                           "A young man going to study at the magic school - Hogwarts",
...
definitely_maybe = media.Movie("Definitely Maybe",
                               "Will tell his daughter about how meet her mother",
                               "https://upload.wikimedia.org/wikipedia/pt/a/a0/Definitely_Maybe_poster.jpg",
...
beauty_and_beast = media.Movie("Beauty and The Beast",
                               "A girl starts to live an enchanted castle with a Beast",
                               ...
                               "2017",
                               "Think of the one thing that you have always wanted. Now find it in your mind is eye and feel it in your heart.")
...
movies = [lord_of_rings, harry_potter, definitely_maybe, me_before_you, beauty_and_beast, star_wars]

#Call the open_movies_page function of the fresh_tomatoes file to create HTML and display favorite movies
